	...
	<header>
		...
		<div class="container" style="padding-top: 80px;">
			...
			<form class="form-horizontal" id="formulariocomercio" action="javascript:void(0);" enctype="multipart/form-data"> 
				...
				$modificar = mysqli_query($conectado,"SELECT * FROM comercio INNER JOIN categoria ON categoria.CodiCate = comercio.CateCome WHERE comercio.CodiCome = ".$_SESSION["codigou"]."");
				$modif = mysqli_fetch_array($modificar);
				$nombre = $modif["NombCome"];
				$direccion = $modif["DireCome"];
				$telefono = $modif["TeleCome"];
				$whatsapp = $modif["WhatCome"];
				$password = $modif["PassCome"];
				$rubro = $modif["NombCate"];
				$nrubro = $modif["CateCome"];
				$email = $modif["MailCome"];
				$logo = $modif["LogoCome"];
				$foto = $modif["FotoCome"];
				 ?>
			...
			<div class="form-group">
		        ...
		        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-5">
		            <input type="text" class="form-control" name="nombre" id="nombre" required="true" <?php echo 'value="'.$nombre.'"' ?> >
		        </div>
		        ...
		        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-5">
		            ...
		            <?php
		            	...
		            	$result = mysqli_query($conectado,"SELECT CodiCate, NombCate from categoria ORDER BY NombCate ASC");
		            	  $opciones = "<option value='".$nrubro."''>".$rubro."</option>";
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-5">
		            <input type="text" class="form-control" name="direccion" id="direccion"  <?php echo 'value="'.$direccion.'"' ?> >
		        </div>
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-5">
		            <input type="number" class="form-control" name="whatsapp" id="whatsapp" <?php echo 'value="'.$whatsapp.'"'?> >
		        </div>
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-5">
		            <input type="number" class="form-control" name="telefono" id="telefono" <?php echo 'value="'.$telefono.'"' ?> >
		        </div>
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-5">
		        	<?php echo "<div class='containermarq'><img class='img-responsive img-circle crop' src='".$logo."' border='0' width='100%'></div>" ?><br>
		     ...
		     <div class="form-group">
		        ...
		        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-5">
		        	<?php echo "<div class='containermarq'><img class='img-responsive crop' src='".$foto."' border='0' width='100%'></div>" ?><br>
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-5">
		            <input type="email" class="form-control" name="mail" id="mail" disabled="true" <?php echo 'value="'.$email.'"' ?> >
		        </div>
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-5">
		            <input type="text" class="form-control" name="password" id="password" <?php echo 'value="'.$password.'"' ?> >
		        </div>
		    ...
		    <div class="form-group">
		        <div class="col-xs-offset-3 col-xs-9">
		            <input type="submit" id="modificar-btn" class="btn btn-success" value="Modificar" >
		        </div>
		    </div>
